...
import org.jeasy.random.randomizers.ZipCodeRandomizer;
...
public class EasyRandomUtils {
  ...
  public static CountryRandomizer countryGenerator() {
		return new CountryRandomizer();
	}

  public static StreetRandomizer streetGenerator() {
		return new StreetRandomizer();
	}

  public static ZipCodeRandomizer codigoPostalGenerator() {
  ...
  public static FloatRandomizer floatGenerator(long longitud) {
		return new FloatRandomizer(longitud);
	}

  public static IntegerRandomizer integerGenerator(long longitud) {
		return new IntegerRandomizer(longitud);
	}
